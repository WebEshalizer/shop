...
<body>
    ...
    $show = "select * from register inner join roles on register.role_id = roles.id";
    $no = 0;
...
?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="editregister.php?id=<?php echo $row['user_id']?>"><button class="btn btn-warning">Edit</button></a></td>
                                                <td><a href="registerdelete.php?id=<?php echo $row['user_id']?>"><button class="btn btn-danger">Delete</button></a></td>
                                            </tr>
                                            <?php  }?>
                                        </tbody>
                                    </table>
