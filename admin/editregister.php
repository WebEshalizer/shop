             ...
             <div class="container">
                 <div class="page-inner">
                     <div class="page-header">
                         <h3 class="fw-bold mb-3">Update Role</h3>
...
$id = $_GET['id'];
$select = "select * from register where user_id = '$id'";
...
?>
           ...
           if(isset($_POST['update'])){
            ...
            $update = "UPDATE `register` SET `Name` = '$name', `Email` = '$email', `Address` = '$address', `Phone Number` = '$number' WHERE `register`.`user_id` = $id;";
