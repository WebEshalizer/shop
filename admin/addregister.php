...
<?php 
                                    ...
                                    if(isset($_POST['submit'])){
                                       ...
                                       $number = $_POST['number'];
                                       $role = $_POST['role'];
                                        $sql = "INSERT INTO `register` ( `Name`, `Email`, `Address`, `Phone Number`, `Role_id`) VALUES ('$name',  '$email', '$address', '$number', '$role')";
                ...
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-item active submenu">
                            <a data-bs-toggle="collapse  show" href="#sidebarLayouts">
