            ...
            <div class="container">
                <div class="page-inner">
                    <div class="page-header">
                        <h3 class="fw-bold mb-3">Show Category</h3>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Show Category Table</div>
                                </div>
                                <div class="card-body">
...
?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="categorydelete.php?id=<?php echo $row['id']?>"><button class="btn btn-danger">Delete</button></a></td>
                                            </tr>
                                            <?php  }?>
                                        </tbody>
                                    </table>
