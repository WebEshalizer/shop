                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Show Role Table</div>
                                </div>
                                <div class="card-body">
...
?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="editrole.php?id=<?php echo $row['id']?>"><button class="btn btn-warning">Edit</button></a></td>
                                                <td><a href="roledelete.php?id=<?php echo $row['id']?>"><button class="btn btn-danger">Delete</button></a></td>
                                            </tr>
                                            <?php  }?>
                                        </tbody>
                                    </table>
